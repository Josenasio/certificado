...
<div class="container text-center p-4" style="margin-bottom: 20px;">
  <h1 class="text-center mb-4" style="font-size: 2.5rem; font-weight: bold;">RETIFICAR CERTIFICADO</h1>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-4 inputGroupContainer">
        <div class="input-group">
            <span class="input-group-addon"><i class="fas fa-sort"></i>
            </span>
...
<script>
  $(document).ready(function () {
    $("#add-disciplina").click(function () {
      ...
      $.ajax({
        url: '../../secretaria/new_certidao/get_disciplinas.php',
        type: 'POST',
