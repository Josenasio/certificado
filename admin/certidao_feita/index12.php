...
<img src="imagem/brasao.webp" alt="Brasão de S. Tomé e Príncipe" width="120" style="margin-left: 440px; position:absolute">
...
<div style="margin-top: 10px;  margin-bottom:-30px">
    ...
    <?php endif; ?>
            ...
            <span style="font-weight: bolder;">_______________________________________________________________________________________</span>
            
            <div style="margin-left: 556px;"></div>
           
        </div>
        
        <div style="position: relative;left: 556px; padding:0px; font-size:1px; margin-bottom:5px">.</div>
...
?>
 ...
 <span style="color: red;">Total: 104,00</span></span>
        ...
        <div class="justify" style="font-family: 'Times New Roman', serif; font-size: 23px;">
