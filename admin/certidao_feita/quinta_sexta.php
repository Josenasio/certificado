...
?>
    ...
    <span style="font-family: 'Garamond', serif; font-size: 24px; font-weight: bold; font-weight: normal;">
      <span style="font-family: 'Times New Roman', serif; font-size: 23px;">  e ficou </span>
        <span style="font-weight: bold; <?php echo ($mediaExibicao < 50) ? 'color: red;' : ''; ?>">
            <?php echo ($mediaExibicao < 50) ? "Reprovado(a)" : "Aprovado(a)"; ?>
        </span>
    </span>
<?php endif; ?>
...
// Função auxiliar para processar a string de notas e destacar em vermelho as notas menores que 50
...
<div style="margin-top: 10px;  margin-bottom:-30px">
    ...
    <?php endif; ?>
            ...
            <div style="position: absolute; margin-top: 22px; margin-left: 495px;">
                <div style="position: absolute; top: 0; left: 90%; width: 3cm; height: 1px; background-color: black; transform: rotate(55deg); font-weight:bold">_________________________</div>
            </div>
           
        </div>
        
        <div style="position: relative; top: 214px; left: 660px;">
